function RecentSearch({ recentHistory, setRecentHistory, setSelectedHistory }) {
  ...
  const clearSelectedHistory=(selectedIndex)=>{
  ...
  //BELOW DELETE ALL SAME RECENT HISTORY
          ...
          recentHistory.map((item, index) => (
            <div key={index} className="flex justify-between pr-3 py-1">
              ...
              <li
                ...
                className="w-full pl-5 px-5 truncate dark:text-zinc-400 text-zinc-700 dark:hover:bg-zinc-700 cursor-pointer dark:hover:text-zinc-200 hover:bg-red-200 hover:text-zinc-800"
              >
                {item}
              </li>
