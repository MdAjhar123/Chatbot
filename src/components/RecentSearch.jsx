        ...
        {recentHistory &&
          recentHistory.map((item, index) => (
            <li
              ...
              className="pl-5 px-5 truncate dark:text-zinc-400 text-zinc-700 dark:hover:bg-zinc-700 cursor-pointer dark:hover:text-zinc-200 hover:bg-red-200 hover:text-zinc-800"
            >
              {item}
            </li>
          ))}
